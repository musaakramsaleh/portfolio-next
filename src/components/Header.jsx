    ...
    <nav className="bg-gradient-to-r from-blue-500 to-purple-500 p-4 shadow-md bg-opacity-60 fixed w-full z-50">
      ...
      {isOpen && (
        <div className="md:hidden mt-2 space-y-2 bg-gradient-to-r from-blue-500 to-purple-500 p-4 rounded-lg shadow-lg">
          <a href="#introduction" className="block px-4 py-2 text-gray-200 hover:text-white transition duration-300">Introduction</a>
          <a href="#skills" className="block px-4 py-2 text-gray-200 hover:text-white transition duration-300">Skills</a>
          <a href="#experience" className="block px-4 py-2 text-gray-200 hover:text-white transition duration-300">Experience</a>
          <a href="#projects" className="block px-4 py-2 text-gray-200 hover:text-white transition duration-300">Projects</a>
          <a href="#education" className="block px-4 py-2 text-gray-200 hover:text-white transition duration-300">Education</a>
          <a href="#contact" className="block px-4 py-2 text-gray-200 hover:text-white transition duration-300">Contact</a>
        </div>
      )}
    </nav>
  );
